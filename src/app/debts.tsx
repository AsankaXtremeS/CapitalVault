...
export default function DebtsLedger() {
  ...
  const totalRepaid = activeDebts.reduce((sum, d) => sum + d.payment_progress, 0);
  ...
  const handleSaveDebt = () => {
    ...
    if (isNaN(numPrincipal) || numPrincipal <= 0) {
      Alert.alert('Invalid Principal', 'Please enter a valid lending or borrowing amount.');
      return;
    }
  ...
  return (
    <AnimatedScreenWrapper>
      ...
      <View style={styles.tabRow}>
        <TouchableOpacity 
          activeOpacity={0.8}
          style={[styles.tab, activeTab === 'lending' && styles.tabLendingActive]} 
          onPress={() => setActiveTab('lending')}
        >
          <Text style={[styles.tabText, activeTab === 'lending' && styles.tabLendingTextActive]}>
            Lendings
          </Text>
        </TouchableOpacity>
        <TouchableOpacity 
          activeOpacity={0.8}
          style={[styles.tab, activeTab === 'borrowing' && styles.tabBorrowingActive]} 
          onPress={() => setActiveTab('borrowing')}
        >
          <Text style={[styles.tabText, activeTab === 'borrowing' && styles.tabBorrowingTextActive]}>
            Borrowings
          </Text>
        </TouchableOpacity>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.listContent}>
        {activeDebts.length === 0 ? (
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>No active entries locked here.</Text>
            <Text style={styles.emptySubText}>Tap the "+" to log lendings or borrowings.</Text>
          </View>
        ) : (
          activeDebts.map(debt => {
            const outstanding = debt.principal - debt.payment_progress;
            const progressPercent = debt.principal > 0 ? (debt.payment_progress / debt.principal) * 100 : 0;
                ...
                <View style={styles.debtHeader}>
                  <View style={styles.debtHeaderLeft}>
                    ...
                    <View>
                      ...
                      {debt.contact_phone && (
                        <Text style={styles.contactPhone}>📱 {debt.contact_phone}</Text>
                      )}
                    </View>
                  </View>
                  ...
                  <View style={styles.progressBarBg}>
                    <View style={[
                      ...
                      { 
                        ...
                        backgroundColor: activeTab === 'lending' ? '#0A84FF' : '#FF453A' 
                      }
                    ]} />
                  </View>
                </View>
                ...
                <View style={styles.metaRow}>
                  ...
                  {debt.interest_rate > 0 && (
                    <View style={styles.metaCol}>
                      ...
                      <Text style={styles.metaText}>{debt.interest_rate}% monthly rate</Text>
                    </View>
                  )}
                </View>
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>
                {activeTab === 'lending' ? 'Log Money Lent' : 'Log Money Borrowed'}
              </Text>
            ...
            <ScrollView contentContainerStyle={styles.modalFormContent}>
              ...
              <View style={styles.formItem}>
                <Text style={styles.formLabel}>Monthly Interest Rate (%)</Text>
                <TextInput
